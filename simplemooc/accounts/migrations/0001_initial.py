# -*- coding: utf-8 -*-
# Generated by Django 1.11.1 on 2017-06-28 01:08
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=30, unique=True, validators=[django.core.validators.RegexValidator(re.compile('^[\\w.@+-]+$', 32), 'O Nome de Usuário só pode conter letras, digitos ou os sequintes caracteres: @/./+/-/_', 'invalido')], verbose_name='Nome do Usúario')),
